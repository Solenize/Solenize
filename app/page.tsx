      ...
      <div className="flex px-[60px] py-0 items-center gap-[163px] self-stretch pt-[220px]">
        <div className="flex flex-col items-start gap-[30px]">
          <div className="flex flex-col items-start gap-[30px]">
            ...
            <button className="flex px-[40px] py-[15px] justify-center items-center gap-[10px] rounded-[60px] bg-[#06F6EE] hover:bg-[#201D30] hover:text-primary transition-colors duration-300 ease-in-out">
              Get Started
            </button>
          </div>
        </div>
